...
namespace BankingApp {                         // IComparable is in interface.
    class Account : IComparable<Account>, IAccount  // IComparable set this class so that data is now able to be sorted
    {
